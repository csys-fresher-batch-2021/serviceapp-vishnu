...
<body>
	...
	<main class="container-fluid">
		...
		<form action="AddServices" method="post">
			...
			<input type="text" name="services" placeholder="Enter New Service here" required>
		...
		<form action="AddCarServlet" method="post">
			...
			<label for="carname">Add New Car</label> 
			<input type="text" name="carname" placeholder="Enter New Car here" required>
		...
		<form action="AddServiceCenter" method="post">
			<label for="servicecenter">Add New Service Center</label>
			<input type="text" name="servicecenter" required>
			<label for="location">Enter center location</label>
